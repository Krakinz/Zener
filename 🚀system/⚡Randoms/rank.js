...
const UsersCortana = require(`🍃goose/experience`);
const cleanRF = require(`../../🗄server/cleanRF`);
const ꜰᴜᴄᴋ = require(`../../🗄server/oShit`);
const _𝔏𝔞𝔟_ = require(`../../🗄server/_𝔏𝔞𝔟_`);
const { registerFont } = require(`canvas`);
registerFont(`./🗄server/LobsterTwo-Bold.ttf`, {
family: `LobsterTwo-Bold`,
});
registerFont(`./🗄server/SlouchybrushRegular-eZnEB.ttf`, {
family: `SlouchybrushRegular`,
});
registerFont(`./🗄server/TheHeartOfEverythingDemo-KRdD.ttf`, {
...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐙𝐞𝐧𝐞𝐫 𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
try {
𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = await ӄʀǟӄɨռʐ.getProfilePicture(ƈօʀȶǟռǟ.sender);
} catch {
𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = `https://i.postimg.cc/wxWL9G8F/no-profile-picture-300x216.png`;
}
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐙𝐞𝐧𝐞𝐫 𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
UsersCortana.findOne(
{
ID: աɦօֆɛռȶɦǟȶ,
