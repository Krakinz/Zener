...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐙𝐞𝐧𝐞𝐫 𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
return await Zener_Buttons.MIB(
ӄʀǟӄɨռʐ,
chat,
ƈօʀȶǟռǟ,
`🪶 𝐇𝐞𝐲: @${աɦօֆɛռȶɦǟȶռʊʍ},
...
╔════◇🛸 (𝐜)𝐙𝐞𝐧𝐞𝐫 𝐀𝐈
║• *Visit:* github.com/Krakinz/Zener
╚◇║
╔◇║ 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥👇🏽‍ 
...
║- ᴜꜱᴇ 𝚉𝚎𝚗𝚎𝚛 ɪɴ ʙᴏᴛʜ ᴘᴜʙʟɪᴄ-ɢʀᴏᴜᴘꜱ ᴀɴᴅ ᴘʀɪᴠᴀᴛᴇ.
║- ꜱᴏ ᴍᴀɴʏ ᴄᴏᴍᴍᴀɴᴅꜱ ᴛʜᴀᴛ ᴡɪʟʟ ʙʟᴏᴡ ᴜᴘ ᴛʜᴇ ᴇᴠᴇʀʏ-ᴅᴀʏ ᴜꜱᴇ ᴏꜰ ʙᴏʀɪɴɢ ᴡʜᴀᴛꜱᴀᴘᴘ.
║- 𝚉𝚎𝚗𝚎𝚛 ɪꜱ ᴡʀɪᴛᴛᴇɴ ɪɴ [ᴊᴀᴠᴀꜱᴄʀɪᴘᴛ & ᴘʏᴛʜᴏɴ] ᴀɴᴅ ɪꜱ ʙʏ ꜰᴀʀ ᴛʜᴇ ᴏɴᴇ ᴏꜰ ᴍᴏꜱᴛ ᴀᴅᴠᴀɴᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀʙᴏᴛ.
╚◇║
╔◇║⚡ 𝐅𝐫𝐞𝐪𝐮𝐞𝐧𝐭𝐥𝐲 𝐀𝐬𝐤𝐞𝐝 𝐐𝐮𝐞𝐬𝐭𝐢𝐨𝐧𝐬
║
║◇ ❓*What is the reason/topic for this group?*
║ Zener is an Advance Whatsapp User-Bot. You Can Use The Bot in this group or in your respective groups.
║
║◇ *❓How Do I add Zener In My Group?*
║   -Send Your Group Link In: https://chat.whatsapp.com/CsRj8Y3Sz9q1ukoaB5fmkL
...
║
║◇ *❓I want to know how to deploy Zener.*
║ Not Allowed anymore!
║
...
║ Visit: http://github.com/krakinzlab/Zener
║
╚◇║
