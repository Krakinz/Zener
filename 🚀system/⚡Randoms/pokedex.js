...
module.exports = {
name: newScpt,
ƈօʀȶǟռǟӄǟɨʐօ: `*${ᴋᴇɪ}pokedex* _pokemon-name_`,
...
}' -pix_fmt yuv420p -c:v libx264 -movflags +faststart -filter:v crop='floor(in_w/2)*2:floor(in_h/2)*2' './☕shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4'`,
async (Error) => {
if (Error) {
userBadge.Limits = userBadge.Limits + 1;
await userBadge
...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐙𝐞𝐧𝐞𝐫 𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
var PokeInfo = `🪶 𝐇𝐞𝐲: @${աɦօֆɛռȶɦǟȶռʊʍ},
...
ƈօʀȶǟռǟ.chatId,
fs.readFileSync(
`./☕shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4`
),
MessageType.video,
{
mimetype: `video/gif`,
