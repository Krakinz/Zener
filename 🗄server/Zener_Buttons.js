...
`⬡🛸⬡=========================================================================================⬡ 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ⬡`;
const Zener_Text_But = async (ӄʀǟӄɨռʐ, chat, ƈօʀȶǟռǟ, ⋊𝚉𝚎𝚗𝚎𝚛™, MainText) => {
try {
if (ƈօʀȶǟռǟ.isReply) {
...
`⬡🛸⬡=========================================================================================⬡ 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ⬡`;
const Zener_Image_But = async (ӄʀǟӄɨռʐ, chat, ƈօʀȶǟռǟ, MainText, MediaUrl) => {
try {
if (ƈօʀȶǟռǟ.isReply) {
var աɦօֆɛռȶɦǟȶ = ƈօʀȶǟռǟ.sender;
var աɦօֆɛռȶɦǟȶռʊʍ = աɦօֆɛռȶɦǟȶ
...
`⬡🛸⬡=========================================================================================⬡ 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ⬡`;
const Zener_Video_But = async (ӄʀǟӄɨռʐ, chat, ƈօʀȶǟռǟ, MainText, MediaUrl) => {
try {
if (ƈօʀȶǟռǟ.isReply) {
var աɦօֆɛռȶɦǟȶ = ƈօʀȶǟռǟ.sender;
var աɦօֆɛռȶɦǟȶռʊʍ = աɦօֆɛռȶɦǟȶ
...
`⬡🛸⬡=========================================================================================⬡ 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ⬡`;
const Zener_GIF_But = async (ӄʀǟӄɨռʐ, chat, ƈօʀȶǟռǟ, MainText, MediaUrl) => {
try {
if (ƈօʀȶǟռǟ.isReply) {
var աɦօֆɛռȶɦǟȶ = ƈօʀȶǟռǟ.sender;
var աɦօֆɛռȶɦǟȶռʊʍ = աɦօֆɛռȶɦǟȶ
...
return ꜰᴜᴄᴋ.catch(Error, ӄʀǟӄɨռʐ, ⋊𝚉𝚎𝚗𝚎𝚛™, ƈօʀȶǟռǟ, chat);
}
};
`⬡🛸⬡=========================================================================================⬡ 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ⬡`;
